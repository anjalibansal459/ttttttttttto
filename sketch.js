...
function setup(){
    ...
    world = engine.world;
    box1 = new box(300,190,50,70);
    box2 = new box(350,190,50,70);
    box3 = new box(400,190,50,70);
    box4 = new box(450,190,50,70);
    box5 = new box(500,190,50,70);
    box6 = new box(550,190,50,70);
    box7 = new box(600,190,50,70);
    box8 = new box(300,150,50,70);
    box9 = new box(400,150,50,70);
    box10 = new box(500,150,50,70);
    box11= new box(600,150,50,70);
  //  box12= new box(500,200,50,70);
    box13=new box(450,100,50,70)
    box14=new box(400,100,50,70)
    box15=new box(500,100,50,70)
   box16=new box(450,150,50,70)
    box17=new box(800,80,50,70)
    box18=new box(850,80,50,70)
    box19=new box(900,80,50,70)
    box20=new box(950,80,50,70)
    box21=new box(1000,80,50,70)
    box22=new box(850,50,50,70)
    box23=new box(900,50,50,70)
    box24=new box(950,50,50,70)
    box25=new box(900,30,50,70)
    box26=new box(450,50,50,70)
    polygon=new Polygon(20,200,100,100)
    ground2=new Ground(1000,100,500,10)
    ground3=new Ground(500,200,500,10)
    mainGround=new Ground(width/2,400,2000,50)
...
function draw(){
    ...
    stroke("yellow")
    textSize(50)
    text("DRAG AND REALEASE THE POLYGON ",10,350)
